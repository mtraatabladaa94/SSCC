...
namespace SSCC.Views.vProduct.Views.SaleDetailCollectionView{
    public partial class SaleDetailCollectionView : XtraUserControl {
        public SaleDetailCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<SSCC.Views.vProduct.ViewModels.SaleDetailCollectionViewModel>();
