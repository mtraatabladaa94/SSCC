namespace SSCC.Views.vProduct.Views.SaleCollectionView {
    partial class SaleCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "Sale Tasks";
			...
			this.saleCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.saleCollectionViewBindingSource.DataSource = typeof(SSCC.Models.POCO.Sale);
			this.gridControl.DataSource = saleCollectionViewBindingSource;
            ...
            CustomerPopulateColumnParameters.Path = "Customer.CustomerLastName";
			...
			this.gridView.PopulateColumns(typeof(SSCC.Models.POCO.Sale),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(SSCC.Views.vProduct.ViewModels.SaleCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.SaleCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.SaleCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.SaleCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.SaleCollectionViewModel), "Refresh", bbiRefresh));
		...
		private System.Windows.Forms.BindingSource saleCollectionViewBindingSource;
