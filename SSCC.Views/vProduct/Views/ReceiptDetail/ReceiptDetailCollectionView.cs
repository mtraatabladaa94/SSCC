...
namespace SSCC.Views.vProduct.Views.ReceiptDetailCollectionView{
    public partial class ReceiptDetailCollectionView : XtraUserControl {
        public ReceiptDetailCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<SSCC.Views.vProduct.ViewModels.ReceiptDetailCollectionViewModel>();
