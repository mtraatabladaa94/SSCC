namespace SSCC.Views.vProduct.Views.LineCollectionView {
    partial class LineCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "Line Tasks";
			...
			this.lineCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.lineCollectionViewBindingSource.DataSource = typeof(SSCC.Models.POCO.Line);
			this.gridControl.DataSource = lineCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters ProductsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            ProductsPopulateColumnParameters_NotVisible.FieldName = "Products";
		    ProductsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(ProductsPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(SSCC.Models.POCO.Line),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(SSCC.Views.vProduct.ViewModels.LineCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.LineCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.LineCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.LineCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.LineCollectionViewModel), "Refresh", bbiRefresh));
		...
		private System.Windows.Forms.BindingSource lineCollectionViewBindingSource;
