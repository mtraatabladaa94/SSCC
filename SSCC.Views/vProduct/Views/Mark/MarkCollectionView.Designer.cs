namespace SSCC.Views.vProduct.Views.MarkCollectionView {
    partial class MarkCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "Mark Tasks";
			...
			this.markCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.markCollectionViewBindingSource.DataSource = typeof(SSCC.Models.POCO.Mark);
			this.gridControl.DataSource = markCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(SSCC.Models.POCO.Mark),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(SSCC.Views.vProduct.ViewModels.MarkCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.MarkCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.MarkCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.MarkCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.MarkCollectionViewModel), "Refresh", bbiRefresh));
		...
		private System.Windows.Forms.BindingSource markCollectionViewBindingSource;
