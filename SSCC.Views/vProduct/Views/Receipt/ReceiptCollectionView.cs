...
namespace SSCC.Views.vProduct.Views.ReceiptCollectionView{
    public partial class ReceiptCollectionView : XtraUserControl {
        public ReceiptCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<SSCC.Views.vProduct.ViewModels.ReceiptCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as SSCC.Models.POCO.Receipt,
