...
namespace SSCC.Views.vProduct.Views.CustomerCollectionView{
    public partial class CustomerCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<SSCC.Views.vProduct.ViewModels.CustomerCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as SSCC.Models.POCO.Customer,
