namespace SSCC.Views.vProduct.Views.ReceiptDetailView {
    partial class ReceiptDetailView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.mainRibbonPageGroup.Text = "ReceiptDetail Tasks";
			// 
			...
			this.receiptDetailViewBindingSource.DataSource = typeof(SSCC.Models.POCO.ReceiptDetail);
			this.dataLayoutControl1.DataSource = receiptDetailViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.ReceiptLookUpEdit.DataBindings.Add("EditValue", receiptDetailViewBindingSource, "ReceiptID", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			this.SaleLookUpEdit.DataBindings.Add("EditValue", receiptDetailViewBindingSource, "SaleID", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(SSCC.Views.vProduct.ViewModels.ReceiptDetailViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.ReceiptDetailViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.ReceiptDetailViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.ReceiptDetailViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.ReceiptDetailViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.ReceiptDetailViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.ReceiptDetailViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.ReceiptDetailViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.ReceiptDetailViewModel), "ResetLayout", bbiResetLayout));
