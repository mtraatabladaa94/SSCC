...
namespace SSCC.Views.vProduct.Views.MarkCollectionView{
    public partial class MarkCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<SSCC.Views.vProduct.ViewModels.MarkCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as SSCC.Models.POCO.Mark,
