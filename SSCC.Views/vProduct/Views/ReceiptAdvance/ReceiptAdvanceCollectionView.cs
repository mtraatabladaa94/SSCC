...
namespace SSCC.Views.vProduct.Views.ReceiptAdvanceCollectionView{
    public partial class ReceiptAdvanceCollectionView : XtraUserControl {
        public ReceiptAdvanceCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<SSCC.Views.vProduct.ViewModels.ReceiptAdvanceCollectionViewModel>();
