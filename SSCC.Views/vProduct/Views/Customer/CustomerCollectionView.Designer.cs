namespace SSCC.Views.vProduct.Views.CustomerCollectionView {
    partial class CustomerCollectionView {
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "Customer Tasks";
			...
			this.customerCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.customerCollectionViewBindingSource.DataSource = typeof(SSCC.Models.POCO.Customer);
			this.gridControl.DataSource = customerCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters SalesPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            SalesPopulateColumnParameters_NotVisible.FieldName = "Sales";
		    SalesPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(SalesPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(SSCC.Models.POCO.Customer),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(SSCC.Views.vProduct.ViewModels.CustomerCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.CustomerCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.CustomerCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.CustomerCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(SSCC.Views.vProduct.ViewModels.CustomerCollectionViewModel), "Refresh", bbiRefresh));
		...
		private System.Windows.Forms.BindingSource customerCollectionViewBindingSource;
