...
namespace SSCC.Views.vProduct.Views.SaleCollectionView{
    public partial class SaleCollectionView : XtraUserControl {
        public SaleCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<SSCC.Views.vProduct.ViewModels.SaleCollectionViewModel>();
